...
SELECT count(*)
FROM fastfood
WHERE sido = '서울특별시' AND gb = '버거킹';

SELECT count(*)
FROM fastfood
WHERE sido = '서울특별시' AND gb = '맥도날드';

SELECT count(*)
FROM fastfood
WHERE sido = '서울특별시' AND gb = 'KFC';

SELECT count(*)
FROM fastfood
WHERE sido = '서울특별시' AND gb = '롯데리아';
...
SELECT a.sido, a.sigungu , a.cnt bmk, b.cnt l, ROUND(a.cnt/b.cnt, 2) cnt
FROM
    (SELECT sido ,sigungu, COUNT(*) cnt
    FROM fastfood
